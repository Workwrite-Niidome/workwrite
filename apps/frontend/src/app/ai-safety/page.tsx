          ...
          <ul className="space-y-2 list-disc pl-5">
            ...
            <li>
              ...
              <ul className="list-none pl-0 mt-2 space-y-2">
                <li><span className="inline-flex items-center gap-0.5 rounded-full border bg-muted/50 border-border text-muted-foreground text-[10px] px-1.5 py-0.5 mr-1 align-middle font-medium">オリジナル</span>AI利用率10%未満。ほぼ著者自身の執筆</li>
                <li><span className="inline-flex items-center gap-0.5 rounded-full border bg-muted/50 border-border text-muted-foreground text-[10px] px-1.5 py-0.5 mr-1 align-middle font-medium">AI ○%</span>AI利用率10〜50%。実際の利用率を数値で表示</li>
                <li><span className="inline-flex items-center gap-0.5 rounded-full border bg-violet-500/10 border-violet-500/30 text-violet-600 dark:text-violet-400 text-[10px] px-1.5 py-0.5 mr-1 align-middle font-medium">AI Generated</span>AI利用率50%超。AI主体の作品として明示</li>
              </ul>
            </li>
            <li>
