...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const register = useCallback(async (email: string, password: string, name: string, referrerId?: string) => {
    const res = await api.register({ email, password, name, referrerId });
    setAuth(res.data);
  }, [setAuth]);
